(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.material = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":2,"core-js/shim":295,"regenerator-runtime/runtime":305}],2:[function(require,module,exports){
...
},{"css-color-names":297}],297:[function(require,module,exports){
module.exports={
  "aqua": "#00ffff",
  "aliceblue": "#f0f8ff",
  "antiquewhite": "#faebd7",
...
},{"css-color-names":298,"is-blank":301,"is-named-css-color":303,"rgb":307,"wcag-contrast":308}],300:[function(require,module,exports){
'use strict';
...
},{"is-empty":302,"is-whitespace":304}],302:[function(require,module,exports){
...
},{"css-color-list":296}],304:[function(require,module,exports){
/*!
...
},{"hex-rgb":300,"relative-luminance":306}],309:[function(require,module,exports){
"use strict";
...
},{"./elevation":316,"./text":324,"jsua-query":326}],310:[function(require,module,exports){
"use strict";
...
function getTheme(options) {
  ...
  if (options.theme) {
    return options.theme === "light" ? _colorScheme.colorScheme.lightTheme : _colorScheme.colorScheme.darkTheme;
  }

  return _colorScheme.colorScheme.theme;
}
...
function statusBar(element, options) {
  var theme = getTheme(options);
  (0, _jsuaQuery.query)(element).each(function (el) {
    return el.style.backgroundColor = theme[0];
  });
};
...
function appBar(element, options) {
  var theme = getTheme(options);
  (0, _jsuaQuery.query)(element).each(function (el) {
    return el.style.backgroundColor = theme[1];
  });
};
...
function main(element, options) {
  var theme = getTheme(options);
  (0, _jsuaQuery.query)(element).each(function (el) {
    return el.style.backgroundColor = theme[2];
  });
};
...
function dialog(element, options) {
  var theme = getTheme(options);
  (0, _jsuaQuery.query)(element).each(function (el) {
    return el.style.backgroundColor = theme[3];
  });
};
...
function accent(element, options) {
  var shade = getShade(options, "A200");
  var color = colorPalette.getColor(_colorScheme.colorScheme.accent, shade);
  (0, _jsuaQuery.query)(element).each(function (el) {
    return el.style.backgroundColor = color;
  });
};

function primary(element, options) {
  var shade = getShade(options, 500);
  var color = colorPalette.getColor(_colorScheme.colorScheme.primary, shade);
  (0, _jsuaQuery.query)(element).each(function (el) {
    return el.style.backgroundColor = color;
  });
};

},{"./color-palette":313,"./color-scheme":314,"jsua-query":326}],311:[function(require,module,exports){
"use strict";
...
},{"./elevation":316,"./text":324,"jsua-query":326}],312:[function(require,module,exports){
module.exports={
  "Red": {
    "50": "#FFEBEE",
    "100": "#FFCDD2",
...
function getTextColor(name, shade, category) {
  ...
  var darkRatio = _getContrast2.default.ratio(backgroundColor, black);
  var lightRatio = _getContrast2.default.ratio(backgroundColor, white);
...
function primaryText(name, shade) {
  return getTextColor(name, shade, "primary");
}

function secondaryText(name, shade) {
  return getTextColor(name, shade, "secondary");
}

function disabledText(name, shade) {
  return getTextColor(name, shade, "disabled");
}

function divider(name, shade) {
  return getTextColor(name, shade, "divider");
}

},{"./color-palette.json":312,"get-contrast":299}],314:[function(require,module,exports){
"use strict";
...
},{"./color-palette":313}],315:[function(require,module,exports){
module.exports={
  "shadows": [
    "none",
...
},{"./elevation.json":315}],317:[function(require,module,exports){
"use strict";
...
function expansionPanel(options) {
  options = options || {};
  var backgroundColor = options.backgroundColor || _colorScheme.colorScheme.theme[2];
  ...
  function addDropdown(el) {
    ...
    (0, _jsuaQuery.query)(dropdown).each([(0, _jsuaQuery.on)("mouseover", function (el) {
      return el.style.border = (0, _util.getDividerStyle)(backgroundColor);
    }), (0, _jsuaQuery.on)("mouseout", function (el) {
      return el.style.border = "1px solid " + backgroundColor;
    })]);
  ...
  return [function (el) {
    ...
    return el.style.backgroundColor = backgroundColor;
  }, text.body(backgroundColor), addDropdown, addShadowDOM];
}

},{"./color-palette":313,"./color-scheme":314,"./elevation":316,"./text":324,"./util":325,"jsua-query":326}],318:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.colorScheme = exports.textInput = exports.textField = exports.expansionPanel = exports.card = exports.appBar = exports.raisedButton = exports.responsiveUI = exports.elevation = exports.colorPalette = exports.background = exports.text = exports.layout = undefined;
...
exports.raisedButton = _raisedButton.raisedButton;
...
},{"./app-bar":309,"./background":310,"./card":311,"./color-palette":313,"./color-scheme":314,"./elevation":316,"./expansion-panel":317,"./layout":319,"./raised-button":320,"./responsive-ui":321,"./text":324,"./text-field":322,"./text-input":323,"babel-polyfill":1}],319:[function(require,module,exports){
"use strict";
...
function raisedButton(element, options) {
  var backgroundColor = options && options.backgroundColor || _colorScheme.colorScheme.primary;
  ...
  (0, _jsuaQuery.query)(element).each([function (el) {
    ...
    return el.style.backgroundColor = backgroundColor;
  }, text.button(backgroundColor), (0, _elevation2.default)(2),
  ...
  function (el) {
    ...
    (0, _jsuaQuery.query)(wrapper).each([function (el) {
      return el.style.display = "flex";
    }, function (el) {
      return el.style.flexDirection = "column";
    }, function (el) {
...
},{"./color-scheme":314,"./elevation":316,"./text":324,"jsua-query":326}],321:[function(require,module,exports){
"use strict";
...
},{"./layout":319,"jsua-query":326}],322:[function(require,module,exports){
"use strict";
...
},{"./color-scheme":314,"./elevation":316,"./text":324,"./util":325,"jsua-query":326}],323:[function(require,module,exports){
"use strict";
...
function textInput(element, options) {
  ...
  text.input(backgroundColor), (0, _jsuaQuery.on)("focusin", [function (el) {
    return el.style.borderBottom = "2px solid " + _colorScheme.colorScheme.accent;
  }, function (el) {
    return el.style.paddingBottom = "6px";
...
},{"./color-scheme":314,"./text":324,"./util":325,"jsua-query":326}],324:[function(require,module,exports){
"use strict";
...
function caption(element, options) {
  options = options || {};
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
function body2(element, options) {
  options = options || {};
  var fontSize = options.desktop ? "13px" : "14px";
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
function subHeading(element, options) {
  options = options || {};
...
function subHeading2(element, options) {
  options = options || {};
  var fontSize = options.desktop ? "15px" : "16px";
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
function title(element, options) {
  options = options || {};
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
function headline(element, options) {
  options = options || {};
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
function display2(element, options) {
  options = options || {};
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
function display3(element, options) {
  options = options || {};
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
function display4(element, options) {
  options = options || {};
  var backgroundColor = options.backgroundColor || getTheme(options)[2];
...
},{"./color-palette":313,"./color-scheme":314,"jsua-query":326}],325:[function(require,module,exports){
"use strict";
...
},{"./color-palette":313}],326:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.on = exports.query = undefined;
...
},{"./on":327,"./query":328}],327:[function(require,module,exports){
"use strict";
...
},{"./util":329}],328:[function(require,module,exports){
"use strict";
...
},{"./util":329}],329:[function(require,module,exports){
"use strict";
